...
const About = () => {
  return (
    <div className="title">
      <h1>About Ugly Delicious</h1>
        <div id="content">
          <div class="col">
            <img src={eggplants} alt={"eggplants"}/>
          </div>
          <div class="col">
            <p>I created Ugly Delicious because I am passionate about food - and I hate to see it go to waste.</p>
            ...
            <ol className="mission-statement">
              ...
              <li>As much as I can, help decrease the rate of hunger in our country.</li><br/>
            </ol>
